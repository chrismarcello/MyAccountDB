...
themepath:"https://ajax.googleapis.com/ajax/libs/jqueryui/",jqueryuiversion:"1.10.1",initialtext:"Switch Theme",buttonpretext:"Theme:",closeonselect:!0,buttonheight:14,cookiename:"jquery-ui-theme",themes:[],additionalthemes:[],onopen:null,onclose:null,onselect:null,cookieexpires:365,cookiepath:"/"};c&&(d.each(c,function(a,b){i[a.toLowerCase()]=b}),d.extend(a,i));var k=a.themes.length?a.themes:[{title:"Black Tie",name:"black-tie",icon:"theme_90_black_tie.png"},{title:"Blitzer",name:"blitzer",icon:"theme_90_blitzer.png"},
